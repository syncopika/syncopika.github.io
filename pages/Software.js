		...
		`<div id='softwareContent'>
			...
			<div id='projectsGrid'>
				...
				<div>
					...
					<br>
					<p> JavaScript, jQuery, HTML, SCSS, Web Audio API </p>
					<p> This project lets you compose music in the browser! I also created an incomplete companion application called <a href='https://syncopika.github.io/soundmaker/'><b> soundmaker </b></a> to create custom instruments that you could import into the piano roll.</p>
					<br>
				</div>
                ...
                <div>
					...
					<br>
                    <p> JavaScript (three.js), HTML, CSS, Blender </p>
