    ...
    template:
        `<div id='softwareContent'>
            ...
            <div id='projectsGrid'>
                ...
                <div>
                    <h4 class="projectTitle"><a href='https://syncopika.github.io/music-visualizer-web/'> recordable 3D music visualizer </a></h4>
                    <div id="musicVisualizerWeb" class="imgContainer">
                        <img 
