const Software = {
	template:
		`<div id='softwareContent'>
			...
			<p>I would say this was one of my first 'serious' projects and has been fun to work on. It's written in C++ and uses the Win32 API (for the GUI as well so the appearance certainly isn't the greatest). I've also used it quite a bit to generate gifs of my projects :) </p>
			<br>
			
			<h4><b><a href='https://syncopika.github.io/music-score-viewer/'> music score viewer </a></b></h4>
			<p>Nothing super special but this is a tool that allows you to sync music score page turning (a pdf score) with audio with some manual intervention in the form of JSON. It utilizes pdf.js and a bit of React. I use it to showcase some of my music composition/arrangement work.</p>
			<br>
			...
			<br>
			<br>
			<h4><a href='#/novelties'><b>here's a list of smaller projects that I'm also fond of but would rather not clutter this page with them → </b><a href='#/novelties'> </a></h4>
			<br>
		</div>`
}
