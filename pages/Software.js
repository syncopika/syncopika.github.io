		...
		`<div id='softwareContent'>
			...
			<div id='projectsGrid'>
				...
				<div>
					...
					<p> This project is definitely one of my favorites. It lets you compose music in the browser! It's made of mostly vanilla JS, HTML and CSS and leverages the Web Audio API and a bit of jQuery. </p>
				...
				<div>
					...
					<p>Nothing super special but this is a tool that allows you to sync music score page turning (a pdf score) with audio with some manual intervention in the form of JSON. It utilizes pdf.js and a bit of React (for routing). I use it to showcase some of my music composition/arrangement work.</p>
					<br>
				</div>
